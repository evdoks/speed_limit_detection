...
def visualize_gt(image_key, anno, color='green', alpha=125, font=None):
    ...
    with Image.open(os.path.join('images/train', '{:s}.jpg'.format(image_key))) as img:
        ...
        for obj in anno['objects']:
            ...
            class_name = f"{obj['label']}"
            #  class_name = f"{obj['label']} {key}"
...
if __name__ == '__main__':
    image_key = '_ea2ess7ZlbdBZlQsQ66Mg'
